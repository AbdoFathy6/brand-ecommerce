...
const ListNav = ({ categories = [], selectedCategory, handleCategorySelect }) => {
    ...
    return (
        <div className="mb-lg-3 m-0 py-0 border bg-light bg-body-tertiary rounded-lg-1 Navlist ">
            {isLargeScreen ? (
                <div className="container-fluid d-lg-flex d-none align-items-center justify-content-between rounded">
                    ...
                    <ul className="navbar-nav d-lg-flex d-none align-items-baseline ms-auto py-2 mb-2 mb-lg-0">
                        <li className="d-flex ">
