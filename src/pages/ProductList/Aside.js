...
const Aside = ({ categories = [], selectedCategory, handleCategorySelect }) => {
    ...
    return (
        <aside className="col-xl-3 col-lg-3 ps-0 d-lg-block d-none overflow-hidden">
            <div className="content">
                <Accordion defaultActiveKey={['0', '1', '2', '3', '4']} className="border-0">
