    ...
    return (
        <section className="mb-3 mt-lg-5 mt-1 p-0">
            <Row className="gx-0 mt-3">
                {!isMobile && (
                    <Col lg={3} className="p-4 d-lg-block d-none bg-cover-2">
                        <aside>
                            <h3 className="mb-3 text-black">Home and<br />Outdoor</h3>
                ...
                <Col lg={9} className="bg-white ">
                    ...
                    {
                        isMobile ? (
                            <Swiper spaceBetween={10} slidesPerView={2} className='h-75 ' style={{ height: '270px' }}>
                                    ...
                                    <SwiperSlide key={index} className='m-0 rounded-0'>
                                        ...
                                        >
                                            <Card style={{ width: '100%', height: "100%", borderRadius: "0", borderRight: 'none' }}>
                                                <Card.Img variant="top" src={product.image} alt={product.title} className='swiper-card offerImg  px-4 py-2' style={{ marginLeft: '30px' }} />
                                                <Card.Body className='body'>
                                                    <Card.Title className='small'>{product.title.split(' ').slice(0, 2).join(' ')}</Card.Title>
